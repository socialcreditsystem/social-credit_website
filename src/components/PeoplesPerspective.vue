<template>
  <section class="peoples-perspective" id="peoples-perspective">
      <div class="container">
...
let person1 = ["Interview 5, June 2018", "Sometimes there is not enough money left in Alipay and Sesame Credit can be used for ordering delivery food.This is convenient and increases life quality."]
