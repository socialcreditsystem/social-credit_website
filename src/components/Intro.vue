    ...
    <section class="intro">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8 intro__text-wrapper">
                    <h2 class="section__heading"><span class="section__heading--bold">Social Credit System</span><span class="section__heading--light"> What?</span></h2>
                    ...
                    <img class="section__image" src="https://picsum.photos/1400/1000" alt="Chinese people being rated by a camera software (symbolic picture)">
                </div>
            </div>
        </div>
    </section>
